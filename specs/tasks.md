...
| ID    | 任务                          | 优先级 | 依赖         | 状态 |
| ----- | ----------------------------- | ------ | ------------ | ---- |
| 2.1.1 | 创建 AI 服务基类 `base_ai.py` | 🔴 P0  | 1.2.1        | [ ]  |
| 2.1.2 | 实现豆包 API 客户端           | 🟠 P1  | 2.1.1        | [ ]  |
| 2.1.3 | 实现 Ollama 客户端 (qwen3:4b) | 🟠 P1  | 2.1.1        | [ ]  |
| 2.1.4 | 实现模型自动切换逻辑          | 🟡 P2  | 2.1.2, 2.1.3 | [ ]  |

### 2.2 内容分析功能

| ID    | 任务                        | 优先级 | 依赖         | 状态 |
| ----- | --------------------------- | ------ | ------------ | ---- |
| 2.2.1 | 设计高光提取 Prompt         | 🟠 P1  | 2.1.1        | [ ]  |
| 2.2.2 | 实现高光片段提取逻辑        | 🟠 P1  | 2.2.1, 1.3.4 | [ ]  |
| 2.2.3 | 创建分析结果数据模型        | 🟠 P1  | 2.2.2        | [ ]  |
| 2.2.4 | 创建分析 API `/api/analyze` | 🟠 P1  | 2.2.3        | [ ]  |

### 2.3 标题生成功能

| ID    | 任务                                | 优先级 | 依赖  | 状态 |
| ----- | ----------------------------------- | ------ | ----- | ---- |
| 2.3.1 | 设计标题生成 Prompt                 | 🟠 P1  | 2.1.1 | [ ]  |
| 2.3.2 | 实现标题生成逻辑                    | 🟠 P1  | 2.3.1 | [ ]  |
| 2.3.3 | 创建标题 API `/api/titles/generate` | 🟠 P1  | 2.3.2 | [ ]  |

### 2.4 评分系统

| ID    | 任务               | 优先级 | 依赖  | 状态 |
| ----- | ------------------ | ------ | ----- | ---- |
| 2.4.1 | 定义评分维度和算法 | 🟡 P2  | 2.2.3 | [ ]  |
| 2.4.2 | 实现片段评分逻辑   | 🟡 P2  | 2.4.1 | [ ]  |
| 2.4.3 | 评分结果展示 UI    | 🟡 P2  | 2.4.2 | [ ]  |
...
| ID    | 任务                 | 优先级 | 依赖  | 状态 |
| ----- | -------------------- | ------ | ----- | ---- |
| 3.1.1 | 创建 FFmpeg 工具模块 | 🔴 P0  | 1.2.1 | [ ]  |
| 3.1.2 | 实现视频信息读取功能 | 🟠 P1  | 3.1.1 | [ ]  |
| 3.1.3 | 实现视频时间段切割   | 🟠 P1  | 3.1.1 | [ ]  |
| 3.1.4 | 实现缩略图生成       | 🟡 P2  | 3.1.1 | [ ]  |

### 3.2 视频切割功能

| ID    | 任务                              | 优先级 | 依赖  | 状态 |
| ----- | --------------------------------- | ------ | ----- | ---- |
| 3.2.1 | 创建切割任务队列                  | 🟠 P1  | 3.1.3 | [ ]  |
| 3.2.2 | 实现批量切割接口 `/api/video/cut` | 🟠 P1  | 3.2.1 | [ ]  |
| 3.2.3 | 创建切割进度展示 UI               | 🟠 P1  | 3.2.2 | [ ]  |
